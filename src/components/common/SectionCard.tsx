    ...
    <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
      ...
      >
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-center justify-center w-12 h-12 bg-teal-100 text-teal-600 rounded-xl">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="bg-gray-100 hover:bg-gray-200 transition-colors text-gray-700 font-semibold text-sm px-5 py-2 rounded-lg"
                  >
                    View
                  </a>
                  <a
